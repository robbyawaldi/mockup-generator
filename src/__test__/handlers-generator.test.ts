...
test("generator should create handlers based on specified file paths", async () => {
  ...
  const expected = await prettier.format(
    ...
    const httpGet = {"api/books": await import("./jsons/get/books.json")};
    const httpPost = {"api/summary/overview": await import("./jsons/post/summary/overview.json"),"api/users/*": await import("./jsons/post/users/*detail.json"),"api/users": await import("./jsons/post/users/index.json")};
    const httpPut = {};
    const httpPatch = {};
